...
rq run -R -J r-erfinv -- ${REP[@]//} --save-as r-erfinv.yaml --min-T 0.01 --fake-erfinv-mean-energy 0 --fake-erfinv-N 10

rq run -R -J r-gaussian -- ${REP[@]//} --save-as r-gaussian.yaml --min-T 0.01 --fake-gaussian-sigma 0.1

rq run -R -J r-linear -- ${REP[@]//} --save-as r-linear.yaml --min-T 0.01 --fake-linear

rq run -R -J r-quadratic -- ${REP[@]//} --save-as r-quadratic.yaml --min-T 0.001 --fake-quadratic-dimensions 3
...
rq run -R -J t-gaussian -- ${TRA[@]//}  --fake-gaussian-sigma 0.1 --save-as t-gaussian.yaml --min-T 0.01 --f '0.5'
