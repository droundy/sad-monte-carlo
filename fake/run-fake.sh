...
rq run -c all --max-output=30 -R -J r-pieces -- ${REP[@]//} --save-as r-pieces.yaml --min-T 0.001 --fake-pieces-a 2.0 --fake-pieces-b 4.0 --fake-pieces-e1 1.0 --fake-pieces-e2 3.0
...
for de in 0.001 0.01 0.1; do
  ...
  rq run -R -J sad-pieces-$de -- ${SAD[@]//} --histogram-bin $de --fake-pieces-a 2.0 --fake-pieces-b 4.0 --fake-pieces-e1 1.0 --fake-pieces-e2 3.0 --save-as sad-pieces-$de.yaml --sad-min-T 0.001
done
...
rq run -R -J t-pieces -- ${TRA[@]//}  --fake-pieces-a 2.0 --fake-pieces-b 4.0 --fake-pieces-e1 2.0 --fake-pieces-e2 3.0 --save-as t-pieces.yaml --min-T 0.001 --f '0.5'
