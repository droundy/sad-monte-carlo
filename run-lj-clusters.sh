...
rq run -R -J 'lj-sad-benchmark-2' target/release/lj-cluster --N 31 --max-allowed-energy=-50 --min-allowed-energy=-133.53 --sad-min-T 0.005 --translation-scale 0.05 --energy-bin 0.05 --save-as lj-sad-31-benchmark-2.yaml --movie-time '10^(1/8)' --save-time 0.5 --n-radial 151 --radius 3 --seed=3

rq run -R -J 'lj-sad-benchmark-3' target/release/lj-cluster --N 31 --max-allowed-energy=-80 --min-allowed-energy=-133.53 --sad-min-T 0.005 --translation-scale 0.05 --energy-bin 0.05 --save-as lj-sad-31-benchmark-3.yaml --movie-time '10^(1/8)' --save-time 0.5 --n-radial 151 --radius 3 --seed=3

# Try a different Radius R = 2.5\sigma

rq run -R -J 'lj-sad-benchmark-4' target/release/lj-cluster --N 31 --max-allowed-energy=-80 --min-allowed-energy=-133.53 --sad-min-T 0.005 --translation-scale 0.03 --energy-bin 0.05 --save-as lj-sad-31-benchmark-4.yaml --movie-time '10^(1/8)' --save-time 0.5 --n-radial 151 --radius 2.5 --seed=3

rq run -R -J 'lj-sad-benchmark-5' target/release/lj-cluster --N 31 --max-allowed-energy=-110 --min-allowed-energy=-133.53 --sad-min-T 0.005 --translation-scale 0.03 --energy-bin 0.05 --save-as lj-sad-31-benchmark-5.yaml --movie-time '10^(1/8)' --save-time 0.5 --n-radial 151 --radius 2.5 --seed=3

rq run -R -J 'lj-sad-benchmark-6' target/release/lj-cluster --N 31 --max-allowed-energy=-80 --min-allowed-energy=-133.53 --sad-min-T 0.005 --translation-scale 0.01 --energy-bin 0.01 --save-as lj-sad-31-benchmark-6.yaml --movie-time '10^(1/8)' --save-time 0.5 --n-radial 151 --radius 2.5 --seed=3
