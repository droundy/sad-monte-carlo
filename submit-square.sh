...
rq run -R -J samc-1e7_1000 target/release/energy-mc --N 1000 --filling-fraction 0.22 --samc-t0 1e7 --well-width 1.3 --movie-time '10^(1/4)' --save-as samc-1e7_1000.yaml --translation-scale 0.05 --save-time 0.5
